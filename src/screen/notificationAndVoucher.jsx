...
const NotificationAndVoucher = () => {
  ...
  const categories = [
    { id: 1, name: "All", image: "...", total_dishes: 5 },
    { id: 2, name: "Fast Food", image: "...", total_dishes: 5 },
    { id: 3, name: "Italian", image: "...", total_dishes: 5 },
    { id: 4, name: "Chinese", image: "...", total_dishes: 5 },
    { id: 5, name: "Indian", image: "...", total_dishes: 5 },
    { id: 6, name: "Mexican", image: "...", total_dishes: 5 },
  ];
